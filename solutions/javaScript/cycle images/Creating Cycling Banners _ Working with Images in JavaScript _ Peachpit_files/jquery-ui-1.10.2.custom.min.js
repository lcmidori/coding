...
/* Includes contents of jquery-ui-tabs-rotate.min.js, which replaces the deprecated jqueryui function (Used on Que home page) */
...
/* Contents of jquery-ui-tabs-rotate.min.js, which replaces the deprecated jqueryui function */

(function(e){e.extend(e.ui.tabs.prototype,{rotation:null,rotationDelay:null,continuing:null,rotate:function(e,n){var r=this,i=this.options;if((e>1||r.rotationDelay===null)&&e!==undefined){r.rotationDelay=e}if(n!==undefined){r.continuing=n}var s=r._rotate||(r._rotate=function(t){clearTimeout(r.rotation);r.rotation=setTimeout(function(){var e=i.active;r.option("active",++e<r.anchors.length?e:0)},e);if(t){t.stopPropagation()}});var o=r._unrotate||(r._unrotate=!n?function(e){if(e.clientX){r.rotate(null)}}:function(e){t=i.active;s()});if(e){this.element.bind("tabsactivate",s);this.anchors.bind(i.event+".tabs",o);s()}else{clearTimeout(r.rotation);this.element.unbind("tabsactivate",s);this.anchors.unbind(i.event+".tabs",o);delete this._rotate;delete this._unrotate}if(e===1){e=r.rotationDelay}return this},pause:function(){var e=this,t=this.options;e.rotate(0)},unpause:function(){var e=this,t=this.options;e.rotate(1,e.continuing)}})})(jQuery)